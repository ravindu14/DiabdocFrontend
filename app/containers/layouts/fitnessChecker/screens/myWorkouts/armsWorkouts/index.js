...
class ArmsWorkoutsScreen extends Component {
  state = {
    selectedDay: "monday",
  };
  ...
  getExercisesByDay = () => {
    ...
    if (selectedDay === "monday") {
      return armExercises.Monday.map((exercise, index) => {
        return (
      ...
      return armExercises.Tuesday.map((exercise, index) => {
        return (
          <Card key={index} style={themedStyle.cardContainer}>
            <CardImage
              source={{
      ...
      return armExercises.Wednesday.map((exercise, index) => {
        return (
          <Card key={index} style={themedStyle.cardContainer}>
            <CardImage
              source={{
      ...
      return armExercises.Thursday.map((exercise, index) => {
        return (
          <Card key={index} style={themedStyle.cardContainer}>
            <CardImage
              source={{
      ...
      return armExercises.Friday.map((exercise, index) => {
        return (
          <Card key={index} style={themedStyle.cardContainer}>
            <CardImage
              source={{
      ...
      return armExercises.Saturday.map((exercise, index) => {
        return (
          <Card key={index} style={themedStyle.cardContainer}>
            <CardImage
              source={{
      ...
      return armExercises.Sunday.map((exercise, index) => {
        return (
          <Card key={index} style={themedStyle.cardContainer}>
            <CardImage
              source={{
...
const ArmsWorkoutsScreenContainer = connect(
  mapStateToProps,
  Actions
)(ArmsWorkoutsScreen);

export default withStyles(ArmsWorkoutsScreenContainer, (theme) => ({
  container: {
    marginHorizontal: 16,
    marginVertical: 10,
